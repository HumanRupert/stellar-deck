    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <motion.div
            className="bg-white/80 backdrop-blur rounded-xl p-4 shadow-lg border border-blue-200"
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ delay: 0.2 }}
          >
            <h4 className="font-bold text-blue-700 mb-2">What we need:</h4>
            <ol className="space-y-1.5">
              {whatWeNeed.map((item, i) => (
                ...
                >
                  <span className="font-bold text-blue-500 min-w-[16px]">{i + 1}.</span>
                  {item}
                </motion.li>
              ))}
            </ol>
          ...
          <motion.div
            className="bg-white/80 backdrop-blur rounded-xl p-4 shadow-lg border border-green-200"
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ delay: 0.2 }}
          >
            <h4 className="font-bold text-green-700 mb-2">What Stellar gets:</h4>
        ...
        <motion.div
          className="bg-gradient-to-r from-slate-800 to-slate-900 text-white rounded-xl p-4 text-center"
